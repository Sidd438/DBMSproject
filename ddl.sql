...
--
CREATE TABLE `cancellations` (`booking_id` bigint NOT NULL PRIMARY KEY, `created_at` datetime(6) NOT NULL, `reason` longtext NOT NULL);
--
-- Create model SMS
--
CREATE TABLE `sms` (`id` bigint AUTO_INCREMENT NOT NULL PRIMARY KEY, `body` longtext NOT NULL, `created_at` datetime(6) NOT NULL, `recepient_id` varchar(254) NOT NULL);
--
-- Create model Seat
--
...
-- Create model Email
--
CREATE TABLE `emails` (`id` bigint AUTO_INCREMENT NOT NULL PRIMARY KEY, `subject` varchar(100) NOT NULL, `body` longtext NOT NULL, `created_at` datetime(6) NOT NULL, `recepient_id` varchar(254) NOT NULL);
--
