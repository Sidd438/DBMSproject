...
CREATE TABLE `passengers` (`id` bigint AUTO_INCREMENT NOT NULL PRIMARY KEY, `last_login` datetime(6) NULL, `first_name` varchar(150) NOT NULL, `last_name` varchar(150) NOT NULL, `is_staff` bool NOT NULL, `is_active` bool NOT NULL, `date_joined` datetime(6) NOT NULL, `password` varchar(100) NOT NULL, `email` varchar(254) NOT NULL UNIQUE, `date_of_birth` date NULL, `gender` varchar(2) NOT NULL, `name` varchar(100) NOT NULL, `expense` integer NOT NULL, `is_superuser` bool NOT NULL);

CREATE TABLE `passengers_groups` (`id` bigint AUTO_INCREMENT NOT NULL PRIMARY KEY, `passenger_id` bigint NOT NULL, `group_id` integer NOT NULL);

CREATE TABLE `passengers_user_permissions` (`id` bigint AUTO_INCREMENT NOT NULL PRIMARY KEY, `passenger_id` bigint NOT NULL, `permission_id` integer NOT NULL);
...
CREATE TABLE `bookings` (`id` bigint AUTO_INCREMENT NOT NULL PRIMARY KEY, `status` varchar(20) NOT NULL, `created_at` datetime(6) NOT NULL);
...
CREATE TABLE `flights` (`id` bigint AUTO_INCREMENT NOT NULL PRIMARY KEY, `name` varchar(100) NOT NULL, `start_time` datetime(6) NOT NULL, `end_time` datetime(6) NOT NULL, `price` integer NOT NULL, `source` varchar(100) NOT NULL, `destination` varchar(100) NOT NULL);
...
CREATE TABLE `seats` (`id` bigint AUTO_INCREMENT NOT NULL PRIMARY KEY, `name` varchar(100) NOT NULL, `flight_id` bigint NOT NULL);
...
CREATE TABLE `payments` (`id` bigint AUTO_INCREMENT NOT NULL PRIMARY KEY, `booking_id` bigint NOT NULL UNIQUE);
...
CREATE TABLE `cancellations` (`id` bigint AUTO_INCREMENT NOT NULL PRIMARY KEY, `created_at` datetime(6) NOT NULL, `reason` longtext NOT NULL, `booking_id` bigint NOT NULL);
...
ALTER TABLE `bookings` ADD COLUMN `seat_id` bigint NOT NULL , ADD CONSTRAINT `bookings_seat_id_05dfaa38_fk_seats_id` FOREIGN KEY (`seat_id`) REFERENCES `seats`(`id`);
...
ALTER TABLE `bookings` ADD COLUMN `user_id` bigint NOT NULL , ADD CONSTRAINT `bookings_user_id_6e734b08_fk_passengers_id` FOREIGN KEY (`user_id`) REFERENCES `passengers`(`id`);
...
ALTER TABLE `passengers_groups` ADD CONSTRAINT `passengers_groups_passenger_id_b4628fce_fk_passengers_id` FOREIGN KEY (`passenger_id`) REFERENCES `passengers` (`id`);
...
ALTER TABLE `passengers_user_permissions` ADD CONSTRAINT `passengers_user_perm_passenger_id_626f4e15_fk_passenger` FOREIGN KEY (`passenger_id`) REFERENCES `passengers` (`id`);
...
ALTER TABLE `seats` ADD CONSTRAINT `seats_flight_id_e61b3bde_fk_flights_id` FOREIGN KEY (`flight_id`) REFERENCES `flights` (`id`);

ALTER TABLE `payments` ADD CONSTRAINT `payments_booking_id_fa2b6c3e_fk_bookings_id` FOREIGN KEY (`booking_id`) REFERENCES `bookings` (`id`);
